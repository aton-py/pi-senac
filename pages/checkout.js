...
const Checkout = ({ context }) => {
  ...
  if (orderCompleted) {
    return (
      <div>
        <h3>
          Obrigado! Seu pedido foi processado com sucesso. Nossa equipe entrará
          em contato contigo em breve.
        </h3>
      </div>
    )
  }
  ...
  return (
    <div className="flex flex-col items-center pb-10">
      <Head>
        <title>PI - ADS - Checkout</title>
        <meta name="description" content={`Check out`} />
        <meta property="og:title" content="PI - ADS - Checkpit" key="title" />
      </Head>
      <div
        className="
          ...
          <Link href="/cart">
            <a aria-label="Cart">
              <div className="cursor-pointer flex  items-center">
                ...
                <p className="text-gray-600 text-md">Retorne ao Carrinho</p>
              </div>
            </a>
          </Link>
        </div>
            ...
            <div className="flex flex-1 flex-col md:flex-row">
              ...
              <div className="md:pt-20">
                ...
                <div className="pl-4 flex flex-1 my-2">
                  <p className="text-sm pr-10">Entrega</p>
                  <p className="w-38 flex justify-end">GRÁTIS</p>
                </div>
