  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center pb-10">
        <Head>
          <title>PI - ADS - Cart</title>
          <meta name="description" content={`PI - ADS - Shopping cart`} />
          <meta property="og:title" content="PI - ADS - Cart" key="title" />
        </Head>
        <div
          className="
        ...
        >
          <div className="pt-10 pb-8">
            <h1 className="text-5xl font-light">Carrinho</h1>
          </div>
            ...
            <Link href="/checkout" className="flex flex-1 justify-end">
              <a aria-label="Check out">
                <div className="cursor-pointer flex items-center">
                  <p className="text-gray-600 text-md mr-2">
