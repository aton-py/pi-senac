  ...
  return (
    <>
      ...
      <div className="w-full">
        <Head>
          <title>PI - ADS</title>
          <meta property="og:title" content="PI - ADS" key="title" />
        </Head>
        <div
        ...
        >
          <div className="pt-4 pl-2 sm:pt-12 sm:pl-12 flex flex-col">
            <Tag year="2023" category="Cameras" />
            <Center
              price="200"
              title={inventory[2].name}
              link={`/product/${slugify(inventory[2].name)}`}
            />
            <Footer designer="Nippon" />
          </div>
      ...
      <div className="pt-10 pb-6 flex flex-col items-center">
        <h2 className="text-4xl mb-3">Tendências do momento</h2>
        <p className="text-gray-600 text-sm">
          Equipamentos de alta qualidade pelo melhor preço
        </p>
      </div>
