  ...
  return (
    <>
      <div className="w-full">
        <CartLink />
        <Head>
          <title>PI - ADS - All Categories</title>
          <meta name="description" content={`PI - ADS - All categories`} />
          <meta
            property="og:title"
            content="PI - ADS - All Categories"
            key="title"
          />
        </Head>
        <div
        ...
        "
        >
          <h1 className="text-5xl font-light">Todas Cateogrias</h1>
        </div>
